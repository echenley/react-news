...
describe('abbreviateNumber', function() {
    ...
    it('abbreviates numbers correctly', function() {
        ...
        expect(abbreviateNumber(34567, 2)).toBe('34.57k');
        expect(abbreviateNumber(918395, 1)).toBe('918.4k');
        expect(abbreviateNumber(2134124, 2)).toBe('2.13m');
        expect(abbreviateNumber(47475782130, 2)).toBe('47.48b');
